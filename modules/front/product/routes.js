...
/** Routing is used to user signup **/
routes.post(API_URL + "categories", async (req, res, next) => {
  product.getCategoriesList(req, res, next);
})

routes.post(API_URL + "sub_categories", async (req, res, next) => {
  product.getSubCategoriesList(req, res, next);
})

/** Routing is used to user signup **/
routes.post(API_URL + "delivery_types", async (req, res, next) => {
  product.getDeliveryTypeList(req, res, next);
});

routes.post(API_URL + "filter_types", async (req, res, next) => {
  product.getFilterTypeList(req, res, next);
});

routes.post(API_URL + "times", async (req, res, next) => {
  product.getTimesList(req, res, next);
});
...
routes.get(API_URL + "get_all_masters_list_with_count", async (req, res, next) => {
...
/** Routing is used to user signup **/
routes.get(API_URL + "brandlist", async (req, res, next) => {
  product.getBrandsList(req, res, next);
})

/** Routing is used to user signup **/
routes.get(API_URL + "availability", async (req, res, next) => {
  product.getAvailabilityList(req, res, next);
})

routes.post(API_URL + "wattage_hashrate", async (req, res, next) => {
  product.getWattageAndHashrate(req, res, next);
})
/** Routing is used to user signup **/
routes.post(API_URL + "add_product/:userId", async (req, res, next) => {
...
routes.post(API_URL + "get_delete_product/:userId/:productId", async (req, res, next) => {
  product.postDeleteProduct(req, res, next);
})

/** Routing is used to get all messages and info about user and product **/
routes.post(API_URL + "get_chat_details", async (req, res, next) => {
  product.getChatDetails(req, res, next);
})

/** Routing is used to config the conversation id **/
routes.post(API_URL + "config_conversation", async (req, res, next) => {
  product.configConversation(req, res, next);
})

/** Routing is used to get all chats **/
routes.post(API_URL + "get_chat_history", async (req, res, next) => {
  product.getChatsHistory(req, res, next);  
})

/** Routing is used to update action of offer **/
routes.post(API_URL + "mark_offer_as", async (req, res, next) => {
  product.updateOfferAction(req, res, next);  
})

/** Routing is used to update action of offer **/
routes.post(API_URL + "update_seen_messages", async (req, res, next) => {
  product.updateSeenMessages(req, res, next);  
})

/** Routing is used to place order **/
routes.post(API_URL + "place_order", async (req, res, next) => {
          ...
          if(Number(result.quantity) >= Number(order.quantity)){
            ...
            if(result.userDetail.user_type==0){
              ...
              db.collection("orders").aggregate([
                ...
                console.log(resultPrivateSeller)
...
/** Routing is used to place order **/
routes.post(API_URL + "get_orders_list", async (req, res, next) => {
  product.getOrdersList(req, res, next);  
})

/** Routing is used to place order **/
routes.post(API_URL + "manage_order_request", async (req, res, next) => {
  product.manageOrderRequest(req, res, next);  
})

/** Routing is used to place order **/
routes.post(API_URL + "track_order", async (req, res, next) => {
  product.trackOrder(req, res, next);  
})

/** Routing is used to rate a product **/
routes.post(API_URL + "rate_product", async (req, res, next) => {
  product.rateProduct(req, res, next);  
})

/** Routing is used to rate a product **/
routes.post(API_URL + "get_reviews",  (req, res, next) => {
  product.getReviews(req, res, next);  
})

/** Routing is used to delete review **/
routes.post(API_URL + "delete_review", async (req, res, next) => {
  product.deleteReview(req, res, next);  
})

/** Routing is used to update review **/
routes.post(API_URL + "update_review", async (req, res, next) => {
  product.updateReview(req, res, next);  
})

/** Routing is used to review count **/
routes.post(API_URL + "review_count", async (req, res, next) => {
  product.reviewCount(req, res, next);  
})

 /** This function is used to insert agreed price */  
routes.post(API_URL + "agreed_price", async (req, res, next) => {
...
routes.post(API_URL + "escrow/create_customer", async (req, res, next) => {
...
routes.post(API_URL + "report_product", async (req, res, next) => {
